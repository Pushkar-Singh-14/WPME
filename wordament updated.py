...
path_report="/Users/pushkarsingh/Desktop/Tests/Reports/worament test1.txt"
path_rev="/Users/pushkarsingh/Desktop/revise_words.txt"
path_rev_test="/Users/pushkarsingh/Desktop/revise_words_training.txt"
f_report=open(path,"r")
f_rev=open(path_rev,"a+")
f_rev_test=open(path_rev_test,"a+")
...
last_50=len(Word)-50
for i in range(last_50,len(Word)):
    num_list.append(i)
    c=len(num_list)
for i in range(c):
    try:
        ...
        if (z_input)=="n":
            ...
            f_rev.write(("{} : {} {} \n \n".format(Word[y],Def[y],page_number[y])))
            f_rev_test.write(("{} {} {} \n".format(page_number[y],Word[y],Def[y])))
        else:
            print(Def[y],page_number[y])
